...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    /// <summary>
    /// Open the room node graph editor window if a room node graph scriptable obhect asset is double clicked in the insperctor
    /// </summary>
    ...
    /// </summary>
    private RoomNodeSO IsMouseOverRoomNode(Event currnetEvent)
    {
        for (int i = currentRoomNodeGraph.roomNodeList.Count - 1; i >=0; i--)
        {
            if (currentRoomNodeGraph.roomNodeList[i].rect.Contains(currnetEvent.mousePosition))
            {
    ...
    {
        // if current node graph empty then entrance room node first
    ...
    private void createRoomNode(object mousePositionObject, RoomNodeTypeSO roomNodeType)
    {
        ...
        // add room node to room node graph scriptable object asset datebase
    ...
    private void DeleteSelectedRoomNodes()
    {
        ...
        while (roomNodeDeletionQueue.Count > 0)
        {
            ...
            currentRoomNodeGraph.roomNodeDictionay.Remove(roomNodeToDelete.id);

            // Remove nod from list
            currentRoomNodeGraph.roomNodeList.Remove(roomNodeToDelete);

            // Remove node from Asset datebase
        ...
        foreach (RoomNodeSO roomNode in currentRoomNodeGraph.roomNodeList)
        {
            if (roomNode.childRoomNodeIDList.Count > 0)
            {
                ...
                foreach (string childRoomNodeID in roomNode.childRoomNodeIDList)
                {
                    ...
                    if (currentRoomNodeGraph.roomNodeDictionay.ContainsKey(childRoomNodeID))
                    {
                        DrawConnectionLine(roomNode, currentRoomNodeGraph.roomNodeDictionay[childRoomNodeID]);
    ...
    private void DrawConnectionLine(RoomNodeSO parentRoomNode, RoomNodeSO childRoomNode)
    {
        ...
        // Vector from start to end positon of line
        Vector2 direction = endPosition - startPosition;

        // Calculate normalised perpendicular positons from the mid point
