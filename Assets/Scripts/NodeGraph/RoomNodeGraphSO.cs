...
public class RoomNodeGraphSO : ScriptableObject
{
    ...
    [HideInInspector] public Dictionary<string, RoomNodeSO> roomNodeDictionay = new Dictionary<string, RoomNodeSO>();
    ...
    {
        roomNodeDictionay.Clear();

        // Populate dictionary
        foreach (RoomNodeSO node in roomNodeList)
        {
            roomNodeDictionay[node.id] = node;
        }
    }
